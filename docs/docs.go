...
const docTemplate = `{
        ...
        "/api/v1/events": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by status (scheduled, live, completed, cancelled, postponed)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Search in event names",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Sort field (event_date, event_name, created_at)",
                        "name": "sort",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.EventListResponseREST"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.EventResponseREST"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateEventRequestREST"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.DeleteEventResponseREST"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.AddUserToRoleResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "models.DeleteEventResponseREST": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/models.EventDeleteDataREST"
                },
                "message": {
                    "type": "string"
                },
        ...
        "models.EventDetailREST": {
            "type": "object",
            "properties": {
                "blocks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.BlockSummaryREST"
                    }
                },
                "created_at": {
                    "type": "string"
        ...
        "models.EventListDataREST": {
            "type": "object",
            "properties": {
                "events": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.EventListItemREST"
                    }
                },
                "filters": {
                    "$ref": "#/definitions/models.EventFiltersREST"
                },
                "pagination": {
        ...
        "models.EventListResponseREST": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/models.EventListDataREST"
                },
                "success": {
                    "type": "boolean"
                }
        ...
        "models.EventResponseREST": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/models.EventDetailREST"
                },
                "success": {
                    "type": "boolean"
                }
